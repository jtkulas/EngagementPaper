...
The sampling strategy will consist of Snowball or Referral Sampling to reduce the final instrument from 36 items (4 per "cell") to 18 items (2 per "cell"). Our aim is to obtain about 250 total responses viable for analysis. A Confirmatory Bi-Factor Analysis will be performed to determine the best candidate items for the final assessment. 
