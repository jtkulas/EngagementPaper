...
configural <- cfa(model=substantive, data=SIOPmi, group="Cond") # configural invariance
weak <- cfa(model=substantive, data=SIOPmi, group="Cond", group.equal="loadings") # weak invariance
strong <- cfa(model=substantive, data=SIOPmi, group="Cond", group.equal=c("intercepts", "loadings")) # strong invariance
strict <- cfa(model=substantive, data=SIOPmi, group="Cond", group.equal=c("loadings", "intercepts", "residuals"))
...
configural <- cfa(model=attitudinal, data=SIOPmi, group="Cond") # configural invariance
weak <- cfa(model=attitudinal, data=SIOPmi, group="Cond", group.equal="loadings") # weak invariance
strong <- cfa(model=attitudinal, data=SIOPmi, group="Cond", group.equal=c("intercepts", "loadings")) # strong invariance
strict <- cfa(model=attitudinal, data=SIOPmi, group="Cond", group.equal=c("loadings", "intercepts", "residuals"))
