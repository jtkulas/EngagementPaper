...
```{r CFA.att1, echo=FALSE, warning=FALSE, fig.cap="Substantive factor structure CFA"}
Sub_Model<-'
...
```{r CFA.att2, echo=FALSE, warning=FALSE, fig.cap="Attitudinal factor structure CFA"}
...
```{r CFA.att3, echo=FALSE, warning=FALSE, fig.cap="Bifactor structure"}
