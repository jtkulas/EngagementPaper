...
\author{Eagle I.O}
\date{Most recently updated 2021-04-28}
...
In addition to the below interactive plot \citep[via \texttt{plotly} version 4.9.3;][]{R-plotly}, a full inter-item correlation matrix is located in Appendix \ref{corrs}.

\hypertarget{htmlwidget-a72296d7d41763843230}{}
...
We used \texttt{lavaan} version 0.6.7 \citep{R-lavaan} and \texttt{semPlot} version 1.1.2 \citep{R-semPlot}
...
\hypertarget{htmlwidget-e798e07abcd90df12325}{}

\hypertarget{attitudinal-scales}{%
\subsection{Attitudinal scales}\label{attitudinal-scales}}

\hypertarget{htmlwidget-ddc5650ac5b3641be0d0}{}
