...
semPaths(fit2,"std", edge.label.cex = 0.5, curvePivot = TRUE)
...
| Hierarchical attitudinal |`r fit1.H[3,2]`   |`r fit1.H[4,2]`     |`r fit1.H[23,2]` |`r fit1.H[29,2]`   |`r fit1.H[9,2]`   |`r fit1.H[10,2]`   |`r fit1.H[19,2]`    |
| Hierarchical substantive |`r fit2.A[3,2]`   |`r fit2.A[4,2]`     |`r fit2.A[23,2]` |`r fit2.A[29,2]`   |`r fit2.A[9,2]`   |`r fit2.A[10,2]`   |`r fit2.A[19,2]`    |
...
> Note that the semPlots package has [an option to generate bifactor plots](https://www.rdocumentation.org/packages/semPlot/versions/1.1.2/topics/semPaths) 
