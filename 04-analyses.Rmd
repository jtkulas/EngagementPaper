...
library(psych)
affect <- alpha(together[2:13])  
behave <- alpha(together[14:25])
cogni <- alpha(together[26:37])

absorb <- alpha(together[c(2:5, 14:17, 34:37)])  
vigor <- alpha(together[c(26:29, 6:9, 18:21)])
dedic <- alpha(together[c(30:33, 10:13, 22:25)])
