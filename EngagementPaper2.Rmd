...
abstract: |
  The most popular conceptual attitudinal specification employee engagement implicates sub-dimensions of vigor, dedication, and absorption. The more general tripartite model of attitudes isolates cognitive, behavioral, and affective components. The current investigation documents the development and validation of an intentionally complex engagement measure - one that intentionally crosses the conceptually substantive and elemental attitude components. An initial item set of 72 were culled to 36 via content validation. The 36 candidate items were piloted with a snowball sample of 330 and reduced to 20. The final 18 items were identified via further administration to 743 Prolific respondents. Construct validation was accomplished via 
...
Burnout is a psychological syndrome consisting of exhaustion, cynicism, and inefficacy [see, for example, @leiter_areas_2004].
